...
//        id: webView
//        anchors.fill: parent
//        url: "https://oauth.vk.com/authorize?client_id=6993642&redirect_uri=http://oauth.vk.com/blank.html&display=mobile&scope=friends&response_type=token&v=5.92&state=kotik"
